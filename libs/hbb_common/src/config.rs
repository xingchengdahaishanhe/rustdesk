...
lazy_static::lazy_static! {
    ...
    pub static ref OVERWRITE_LOCAL_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
     pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "mdkj8888".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["3tp.org"];
pub const PUBLIC_RS_PUB_KEY: &str = "EC7XmRhhkCqogr02Avzp4ZG7r2YA0iH69NSZ9KpKesk";
